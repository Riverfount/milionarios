...
main = typer.Typer(name='Milionários CLI')
...
def conferir(dezenas: str, filepath: str = 'jogos.csv'):
    ...
    Deve ser informado o nome do arquivo CSV com os nossos jogos. Por padrão, se não for passado será: jogos.csv.
    """
    table = Table(title="Resultado do Grupo Milionários")
